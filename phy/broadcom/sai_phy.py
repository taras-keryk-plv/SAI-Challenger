...
class SaiPhyImpl(SaiPhy):
    ...
    """
    SAI_SWITCH_ATTR_INIT_SWITCH=true|SAI_SWITCH_ATTR_TYPE=SAI_SWITCH_TYPE_PHY|SAI_SWITCH_ATTR_SWITCH_PROFILE_ID=0|
    ...
    SAI_SWITCH_ATTR_FIRMWARE_LOAD_TYPE=SAI_SWITCH_FIRMWARE_LOAD_TYPE_AUTO|SAI_SWITCH_ATTR_REGISTER_READ=0x55da28c967f0|
    SAI_SWITCH_ATTR_REGISTER_WRITE=0x55da28c96930|SAI_SWITCH_ATTR_HARDWARE_ACCESS_BUS=SAI_SWITCH_HARDWARE_ACCESS_BUS_MDIO|
